...
vignette: >
  %\VignetteIndexEntry{sample_weighting_examples}
...
Doing this without weights gives $\mu$ minimizing an empirical version of $E[(Y_i - \mu(X_i))^2 | W_i=1]$, squared error over the population of units with nonmissing outcomes,
while a more natural measure of imputation quality is $E[(Y_i - \mu(X_i))^2 | W_i=0]$, squared error over the population of units for which we will be imputing outcomes.
