 ...
 */
   ...
   */
    ...
    // set
    void set_target_avg_weights(arma::cube x); // [number target weights, num obs, num input features]

    void set_target_weight_penalty(double target_weight_penalty); // set by user

    void set_target_weight_penalty_metric(std::string metric_type); // methods to calculate penalty 
